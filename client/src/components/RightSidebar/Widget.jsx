  ...
  return (
    <div className='widget'>
        ...
        <div className='right-sidebar-div-1'>
            ...
            <div className='right-sidebar-div-2'>
                    <img src={pen} alt="pen" width='18' />
                     <p>Podcast 374: How valuable is your screnn name? </p>
            </div>
        </div>
        ...
        <div className='right-sidebar-div-1'>
            <div className='right-sidebar-div-2'>
                    <img src={comment} alt="pen" width='18' />
                     <p>Review queue windows -Final release...</p>
            </div>
            <div className='right-sidebar-div-2'>
                    <img src={comment} alt="pen" width='18' />
        ...
        <div className='right-sidebar-div-1'>
            <div className='right-sidebar-div-2'>
                   <p>38</p>
                     <p>Why was this spam flag decliend , yet the question marked as spam?</p>
            </div>
            <div className='right-sidebar-div-2'>
                   <p>20</p>
