  ...
  return (
    <section className='auth-section'>
        ...
        <div className='auth-container'>
            {!isSignup && <img src={icon} alt='stackoverflow'/>}
            <form onSubmit={handleSubmit} >
                ...
                {isSignup && <p style={{color:'#666767',fontSize:"13px"}}>Passwords must contain at least eight<br/>characters, includint at least 1 letter and 1<br/>number.</p>}
                </label>
                {isSignup && (
                    <label htmlFor='check'>
                ...
                {isSignup &&(
                    <p style={{color:'#666767',fontSize:"13px"}}>
                        By clicking "Sign up" you afree to our 
